...
ttk.Label(mainframe, text='Service').grid(
...
ttk.Label(mainframe, text='Email').grid(
...
ttk.Label(mainframe, text='Password').grid(
    row=4, column=0, sticky=E, padx=5, pady=5)g
password_entry = ttk.Entry(mainframe, show='●', textvariable=password)
password_entry.grid(row=4, column=1, sticky=W, padx=5, pady=5)

eye_open = PhotoImage(
    file=r"C:\Users\LENOVO\Documents\Shubh\Python\trans-eye-outline.png", format='PNG')
eye_close = PhotoImage(
    file=r"C:\Users\LENOVO\Documents\Shubh\Python\trans-eye-off-outline.png", format='PNG')
pass_toggle_button = ttk.Button(
    mainframe, image=eye_open, command=pass_toggle)
pass_toggle_button.grid(row=4, column=2, sticky=W)
pass_toggle_button.image = eye_open

ttk.Label(mainframe, text='Phone no').grid(
...
clear = ttk.Button(mainframe, text='Clear fields',
                   command=clear_fields).grid(row=6, column=0, sticky=W)

save = ttk.Button(mainframe, text='Save to file',
                  command=save_to_file).grid(row=6, column=1, columnspan=2, sticky=E)
